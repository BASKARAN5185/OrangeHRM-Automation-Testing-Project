...
public class OrangeHRMLoginPage  {
    ...
    private By sideLogo = By.xpath("//div[@class='orangehrm-login-logo']");
    ...
    public void loginCredantial(String enterusername, String passw) {
        driver.findElement(username).clear();
    ...
    public boolean logoVisible() {
      return  wait.until(driver -> driver.findElement(logo).isDisplayed());
    
    }

    public boolean sideLogoVisible() {
        return wait.until(driver -> driver.findElement(sideLogo).isDisplayed());
    }
