...
public class LoginPageTest extends BaseClass {
    ...
    public OrangeHRMLoginPage login;
    ...
    void loginWithInvalidEmail() {
        login.loginCredantial("baskar@gmail.com", "123");
        wait.until(ExpectedConditions.urlContains("auth/login"));
        Assert.assertEquals(login.getCurrentPageUrl(),
                "https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
    }
    ...
    void loginWithInvalidPassword() {
        login.loginCredantial("Admin", "123");
        wait.until(ExpectedConditions.urlContains("auth/login"));
        Assert.assertEquals(login.getCurrentPageUrl(),
                "https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
    }
    ...
    void loginWithValidCredentials() {
        login.loginCredantial("Admin", "admin123");
    ...
    void invalidUserLogin(String username, String password) {
        login.loginCredantial(username, password);
        wait.until(ExpectedConditions.urlContains("auth/login"));
        Assert.assertNotEquals(login.getCurrentPageUrl(),
                "https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index");
    }
