...
public class Login_Page_test extends BaseClass {
	...
	@Test(priority = 10, groups = { "Smoke", "Regression",
			"LoginTest" }, dataProvider = "UserLogin", dataProviderClass = utility.DataProviderClass.class)
	...
	@Test(priority = 12, groups = { "Smoke", "Regression",
			"LoginTest" }, dataProvider = "New Employee", dataProviderClass = utility.DataProviderClass.class)
	void notCredentialUserNameAndPassword(String user, String pass) {
		login.login(user, pass);
		System.out.println(user + "   " + pass);
		String pageurl = login.LoginValidation();
		Assert.assertNotEquals(pageurl, "https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index");
	}

	@Test(priority = 13, groups = { "Smoke", "Regression", "LoginTest" })
